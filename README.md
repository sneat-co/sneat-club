...
| FC-sneat-club-calendarius-01 | sneat-club | calendarius | fixture-to-family-calendar | Coach rosters a player to a fixture | Cross-space calendar projection | acquires:sneat-app — guardian | planned | ADR 0021 §4 names clubs as a consumer; capability **designed** in [`WINDOW-MODEL.md`](https://github.com/sneat-co/backstage/blob/main/WINDOW-MODEL.md) (ADR 0022), not built. **Unblocked 2026-09-02** by the founder ratification that guardians are Window holders, not club members (OQ9) |
