...
export interface ISneatclubAppState {
  collapsedGroups: string[];
  showWatched: boolean;
}

export abstract class ISneatclubAppStateService extends LocalAppState<ISneatclubAppState> {
...
@Injectable()
export class SneatclubAppStateService extends ISneatclubAppStateService {
  constructor() {
  ...
  public setShowWatched(showWatched: boolean): void {
    const appState: ISneatclubAppState = {
      ...this.getAppState(),
      showWatched,
    };
    this.saveAppState(appState);
