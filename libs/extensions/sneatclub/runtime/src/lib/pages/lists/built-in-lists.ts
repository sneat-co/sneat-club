...
import { IListGroup } from '@sneat/extension-sneatclub-contract';

// Built-in default list groups shown for a space, for instant UX before/alongside
// the lists persisted on the space DBO. Personal and family spaces both get
// To Buy / To Do; other space types have no built-ins. Shared by the lists page
// and the template space menu so they stay consistent.
